 ...
 * This distribution may be useful for analyzing small sample size 
...
public class StudentT extends PDF {
    ...
    // Note: Note: throw IllegalArgumentException if the given area is less than 0 or greater than 1
